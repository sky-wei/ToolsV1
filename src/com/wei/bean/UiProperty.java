...
public class UiProperty {
	...
	public UiProperty(UiProperty uiProperty) {
		
		this.primary1 = uiProperty.getPrimary1();
		this.primary2 = uiProperty.getPrimary2();
		this.primary3 = uiProperty.getPrimary3();
		
		this.secondary1 = uiProperty.getSecondary1();
		this.secondary2 = uiProperty.getSecondary2();
		this.secondary3 = uiProperty.getSecondary3();
		
		this.black = uiProperty.getBlack();
		this.white = uiProperty.getWhite();
		
		this.font = uiProperty.getFont();
		this.boldFont = uiProperty.getBoldFont();
		
		this.opacidadMenu = uiProperty.getOpacidadMenu();
		this.opacidadFrame = uiProperty.getOpacidadFrame();
	}
